...
- [X] T017 [US2] Run property-based test SC-006: BFS/DFS traversal over 1,000 random graph instances verifies 100% communities connected (SC-006) — closed 2026-09-12: root harness rewritten to run real Leiden::detect (seed 42) on generated graphs (path backbone + ≤2n extra edges), ProptestConfig::with_cases(1000); `cargo test --test leiden_connected` 1 passed (12s); clippy 0 errors. Algo-crate suite 3/3 PASS incl. 1000-case test_all_communities_connected
...
- [X] T101 Confirm property-test archive `sc-060-sc006-sc008.json` (PASS 1000/1000) and determinism `test_determinism_basic` (seed 42, byte-for-byte) are finalized and referenced by T079/T083/T087/T091 — completed / MEDIUM / SC-006/SC-008 / T079 / T083 / T091 — confirmed 2026-09-12: archive PASS + fresh root 1000-case green + determinism 7/7 re-verified
